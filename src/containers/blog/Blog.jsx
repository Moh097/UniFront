...
import { blog03, blog04, blog05, sna, trump } from './imports';
import './blog.css';
  ...
  <div className="gpt3__blog section__padding" id="blog">
    ...
    <div className="gpt3__blog-container">
      <div className="gpt3__blog-container_groupA">
        <Article imgUrl={sna} date="Sep 26, 2021" text="Unlock the power of Social Network Analysis" />
      </div>
      <div className="gpt3__blog-container_groupB">
        <Article imgUrl={trump} date="Sep 26, 2021" text="Speach Analysis for Trump speeches in USA election" />
